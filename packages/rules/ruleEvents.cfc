<cfcomponent displayname="Events: Event Listing Rule" extends="farcry.core.packages.rules.rules" hint="Method for displaying dmEvent objects">
	<cfproperty name="displayMethod" type="string" default="displayTeaser" hint="Display method to render this event rule with" ftSeq="1" ftFieldset="" ftLabel="Display method" ftType="webskin" ftTypename="dmEvent" ftPrefix="displayTeaser" />
