...
<cfproperty ftseq="21" ftfieldset="Story Teaser" ftwizardStep="News Body" name="teaserImage" type="UUID" hint="Teaser image to display." required="no" default="" fttype="uuid" ftjoin="dmImage" ftlabel="Teaser Image" 
...
<cfproperty ftseq="22" ftfieldset="Story Teaser" ftwizardStep="News Body" name="Teaser" type="longchar" hint="Teaser text." required="no" default="" ftlabel="Story Teaser" />

<cfproperty ftseq="23" ftfieldset="News Story" ftwizardStep="News Body" name="Body" type="longchar" hint="Main body of content." required="no" default="" ftType="RichText" ftlabel="Body Content"
