...
<cfoutput>
<div class="feed-item">
	<h4><a href="#application.fc.lib.esapi.DecodeFromURL(stparam.item.link)#" target="feed-item">#application.fc.lib.esapi.EncodeForHTML(stparam.item.title)#</a> <small>#application.fapi.prettydate(stparam.item.pubDate)#</small></h4>
