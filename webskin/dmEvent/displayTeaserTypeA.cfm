...
|| VERSION CONTROL ||
$Header: /cvs/farcry/farcry_mollio/webskin/dmEvent/displayTeaserTypeA.cfm,v 1.1 2006/04/04 06:03:54 gstewart Exp $
$Author: gstewart $
...
<cfoutput>
<h4><span class="date">#dateformat(stobj.startDate, "dd mmm yyy")#</span>#stObj.Title#</h4>
<p>
</cfoutput>
